...
(
    ...
    `created_at`   int(11) unsigned zerofill NOT NULL COMMENT '创建时间',
    `updated_at`   int(11) unsigned zerofill NOT NULL COMMENT '更新时间',
    `email`        varchar(255) COLLATE utf8mb4_general_ci                       NOT NULL COMMENT '邮箱',
    `email_verify` tinyint(1) unsigned zerofill NOT NULL COMMENT '邮箱验证 0-未通过 1-通过',
    PRIMARY KEY (`id`),
